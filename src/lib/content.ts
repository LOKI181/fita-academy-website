...
export const masterPrograms: MasterProgram[] = [
  {
    slug: "ai-data-science-master",
    title: "AI & Data Science Master Program",
    description: "From Python foundations to production ML pipelines — a comprehensive 8-month program covering statistics, machine learning, deep learning, NLP, Generative AI and deployment.",
    duration: "8 Months",
    courses: ["Python Full Stack", "Data Science & ML", "Generative AI", "Cloud Basics"],
    highlights: ["Live industry projects", "Kaggle competition prep", "Portfolio of 5+ projects", "Placement support"],
    fees: "₹75,000",
    badge: "Most Popular",
  },
  {
    ...
    description: "Java + React + Node.js + DevOps — master both frontend and backend with real deployment experience across 7 months.",
    duration: "7 Months",
    courses: ["Java Full Stack", "React & Node.js (MERN)", "AWS & DevOps"],
    highlights: ["Dual-stack proficiency", "3 portfolio projects", "GitHub profile grooming", "Mock interview series"],
    fees: "₹68,000",
    badge: "Top Rated",
  },
  {
    slug: "cloud-devops-master",
    title: "Cloud & DevOps Master Program",
    description: "AWS, Azure, Docker, Kubernetes, Terraform and CI/CD — the complete platform engineering track with hands-on labs.",
    duration: "6 Months",
    courses: ["AWS & DevOps", "Production Support & DBA"],
    highlights: ["Cloud certification prep", "Real infra projects", "On-call simulation", "Hiring partner referrals"],
    fees: "₹55,000",
  },
  {
    slug: "digital-marketing-master",
    title: "Digital Marketing Master Program",
    description: "SEO, Google Ads, Meta Ads, content marketing, analytics and social media — become a complete digital marketer in 5 months.",
    duration: "5 Months",
    courses: ["Digital Marketing Mastery", "Spoken English & Communication"],
    highlights: ["Live campaign budgets", "Google Ads certification prep", "Content portfolio", "Internship placement"],
    fees: "₹30,000",
  },
  {
    slug: "software-testing-master",
    title: "Software Testing Master Program",
    description: "Manual testing, Selenium, API testing, performance testing and test automation frameworks — the complete QA engineering track.",
    duration: "5 Months",
    courses: ["Software Testing & Automation", "Production Support & DBA"],
    highlights: ["Framework design from scratch", "Real-time project testing", "ISTQB prep", "Placement support"],
    fees: "₹38,000",
  },
  {
    slug: "ui-ux-master",
    title: "UI/UX Design Master Program",
    description: "Design thinking, Figma mastery, user research, prototyping, design systems and portfolio — become a product designer.",
    duration: "5 Months",
    courses: ["UI / UX Design & Figma", "Digital Marketing Mastery"],
    highlights: ["3 case-study portfolios", "Design system project", "User research methods", "Freelance guidance"],
    fees: "₹32,000",
  },
];
...
export const careerOpenings: CareerOpening[] = [
  {
    ...
    department: "Sales & Counselling",
    location: "Chennai",
    type: "Full-time",
    experience: "0–2 years",
    description: "Guide prospective students through course selection, handle enquiries and convert leads into enrollments. Great for freshers with strong communication skills.",
  },
  {
    id: "bde-01",
    ...
    description: "Build corporate training partnerships, manage employer relationships and drive B2B revenue for FITA's corporate training division.",
  },
  {
    id: "seo-01",
    ...
    type: "Full-time",
    experience: "1–3 years",
    description: "Own organic growth — keyword research, on-page SEO, content strategy and analytics for a high-traffic education website.",
  },
  {
    id: "trainer-01",
    title: "IT Trainer (Java / Python / Cloud)",
    department: "Training",
    location: "Multiple cities",
    type: "Full-time",
    experience: "5+ years",
    description: "Deliver instructor-led classroom and live-online batches. Must have real industry experience, teaching ability and mentoring mindset.",
  },
  {
    id: "hr-01",
    title: "HR Recruiter",
    ...
    type: "Full-time",
    experience: "1–3 years",
    description: "Source, screen and onboard trainers, counsellors and operational staff across FITA's 10+ branches.",
  },
  {
    id: "frontend-01",
    ...
    description: "Build and maintain FITA's web platform with Next.js, TypeScript and Tailwind. Work on course pages, dashboards and student-facing tools.",
  },
];

export const placementRecords: PlacementRecord[] = [
  { studentName: "Vignesh T", course: "Java Full Stack", role: "Java Developer", company: "Infosys", location: "Chennai", year: 2025, month: "Aug", package: "₹4.5 LPA" },
  { studentName: "Lakshmi P", course: "Data Science & ML", role: "Data Analyst", company: "Zoho", location: "Chennai", year: 2025, month: "Aug", package: "₹5.2 LPA" },
  { studentName: "Surya D", course: "AWS & DevOps", role: "DevOps Engineer", company: "Wipro", location: "Bangalore", year: 2025, month: "Jul", package: "₹6.0 LPA" },
  { studentName: "Janani R", course: "React & Node.js", role: "React Developer", company: "TCS", location: "Chennai", year: 2025, month: "Jul", package: "₹4.2 LPA" },
  { studentName: "Naveen M", course: "Software Testing", role: "QA Engineer", company: "Cognizant", location: "Coimbatore", year: 2025, month: "Jun", package: "₹3.8 LPA" },
  { studentName: "Fathima B", course: "UI/UX Design", role: "UX Designer", company: "Freshworks", location: "Chennai", year: 2025, month: "Jun", package: "₹4.8 LPA" },
  { studentName: "Karthik S", course: "Java Full Stack", role: "Software Engineer", company: "HCL", location: "Chennai", year: 2025, month: "May", package: "₹4.0 LPA" },
  { studentName: "Divya M", course: "Digital Marketing", role: "Digital Marketer", company: "Bright", location: "Madurai", year: 2025, month: "May", package: "₹3.5 LPA" },
  { studentName: "Arun R", course: "Python Full Stack", role: "Python Developer", company: "Zoho", location: "Chennai", year: 2025, month: "Apr", package: "₹5.0 LPA" },
  { studentName: "Priya K", course: "Data Science & ML", role: "ML Engineer", company: "Infosys", location: "Bangalore", year: 2025, month: "Apr", package: "₹6.5 LPA" },
  { studentName: "Rahul V", course: "Generative AI", role: "AI Engineer", company: "TCS", location: "Chennai", year: 2025, month: "Mar", package: "₹5.8 LPA" },
  { studentName: "Meena L", course: "Software Testing", role: "SDET", company: "Accenture", location: "Pune", year: 2025, month: "Mar", package: "₹4.5 LPA" },
];
...
export const successStories: SuccessStory[] = [
  {
    name: "Vignesh T",
    course: "Java Full Stack Development",
    previousRole: "B.Sc Graduate (No IT experience)",
    placedRole: "Java Developer",
    company: "Infosys",
    quote: "I joined with zero coding background. The trainers started from basics, built my confidence through real projects, and the placement team prepped me through 12 mock interviews before my first offer.",
    branch: "Anna Nagar, Chennai",
  },
  {
    name: "Lakshmi P",
    course: "Data Science & Machine Learning",
    previousRole: "B.Com Graduate",
    placedRole: "Data Analyst",
    company: "Zoho",
    quote: "The Data Science batch covered way more than basics — statistics, Python, business dashboards. Weekend doubt-clearing sessions were a lifesaver for working professionals like me.",
  ...
  },
  {
    ...
    company: "Wipro",
    quote: "Real AWS labs, Terraform, and a full CI/CD project — I walked into interviews with actual infrastructure I had built, not just theory. That changed everything.",
    branch: "Coimbatore",
  },
  {
    name: "Fathima B",
    ...
    placedRole: "UX Designer",
    company: "Freshworks",
    quote: "Figma mastery and design system sessions were practical, not slide-heavy. I built a portfolio case study during the course itself and got hired before finishing.",
    branch: "Madurai",
  },
  {
    name: "Rahul V",
    course: "Generative AI & LLMs",
    previousRole: "B.Tech CSE (Fresher)",
    placedRole: "AI Engineer",
    company: "TCS",
    quote: "The GenAI program was cutting-edge — prompt engineering, RAG pipelines, agents. I built a deployed AI app during the course that became my interview showpiece.",
    branch: "Anna Nagar, Chennai",
  },
  {
    name: "Janani R",
    course: "React & Node.js Full Stack (MERN)",
    previousRole: "BCA Graduate",
    placedRole: "React Developer",
    company: "TCS",
    quote: "Best part was the weekly mini-projects — by the end I had 4 solid projects on GitHub. The recruiter literally asked me to walk them through my code.",
    branch: "Bangalore",
  },
];